...
list_remove v (h::t) = ite (eql v h) t (h::(list_remove v (h::t)))
...
--ite (eql h1 h2) (h1:: (intersect h1 h2) (intersect t1 t2)
-- Return the intersection of s1 and s2
...
--given a list of as and list a bs return a list of all a b pairs
